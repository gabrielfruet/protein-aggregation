...
\begin{figure}
    \begin{center}
    \includegraphics[width=0.5\linewidth]{../figures/homology_fitness.png}
    \end{center}
\end{figure}
...
monotonicamente crescente entre 0 e 1, mas sempre negativa. Ou seja, a solução
que tera melhor aptidão de homologia é a que tiver a maior homologia.
...
Sendo S a sequência que queremos calcular a aptidão.
